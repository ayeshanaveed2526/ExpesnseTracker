...
const Summary = ({ expenses = [] }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 animate-fade-in-up">
      <div className="bg-surface-bright/40 backdrop-blur-lg rounded-2xl border border-white/10 p-6 hover:border-primary/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(16,185,129,0.1)] hover:-translate-y-1">
      ...
      <div className="bg-surface-bright/40 backdrop-blur-lg rounded-2xl border border-white/10 p-6 hover:border-danger/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(239,68,68,0.1)] hover:-translate-y-1">
        <p className="text-white/60 text-sm font-medium mb-1">Total Spending</p>
        <h3 className="text-3xl font-bold flex items-center">
          <span className="mr-2">Rs.</span>
      ...
      <div className="bg-surface-bright/40 backdrop-blur-lg rounded-2xl border border-white/10 p-6 hover:border-primary/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(16,185,129,0.1)] hover:-translate-y-1">
        ...
        <p className="text-xs text-white/50 mt-2 text-right">{savingsProgress.toFixed(1)}% Achieved</p>
      </div>
    </div>
  );
};
